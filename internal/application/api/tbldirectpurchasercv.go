...
type TblDirectPurchaseRcvApi interface {
	Fetch(c *fiber.Ctx) error
	Create(c *fiber.Ctx) error
	Update(c *fiber.Ctx) error
}

type TblDirectPurchaseRcvHandler struct {
	Service   service.TblDirectPurchaseRcvService  `inject:"tblDirectPurchaseRcvService"`
	Validator validator.Validator                  `inject:"validator"`
	Log       *custommiddleware.LogActivityHandler `inject:"logActivity"`
}

func (h *TblDirectPurchaseRcvHandler) Fetch(c *fiber.Ctx) error {
...
func (h *TblDirectPurchaseRcvHandler) Create(c *fiber.Ctx) error {
	var req *tbldirectpurchasercv.Create
	user := c.Locals("user").(*jwt.Claims)
...
func (h *TblDirectPurchaseRcvHandler) Update(c *fiber.Ctx) error {
	var req *tbldirectpurchasercv.Read
